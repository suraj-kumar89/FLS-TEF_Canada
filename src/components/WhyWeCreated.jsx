    ...
    <section className="why-wrapper">
      <div className="why-container">
        ...
        <div className="why-left">
          ...
          <p className="why-desc">
This CA$ 5 TEF trial class fixes that by giving you one clear, structured plan for your entire A1 to B2+ TEF journey, with a strong focus on exam readiness and score improvement.
          </p>
