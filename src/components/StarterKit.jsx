...
export default function StarterKit() {
 ...
 A Complete TEF Preparation Starter Kit <br />
        <span className="purple-text">Worth CA$ 84+ for Just CA$ 5 -</span>
        <span>
          Total No Brainer
        </span>
      </h2>

      <p className="sub-head">What You Get Inside the TEF Trial Class (Worth CA$ 84+)</p>
      ...
      <div className="starter-grid">
        ...
        <div className="starter-total-box">
          <h3>Total Value CA$ 84+</h3>
          <p>Your Price Today CA$ 5</p>
        </div>
      </div>
    </section>
  );
